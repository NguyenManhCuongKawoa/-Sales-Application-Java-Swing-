...
class Surface extends JPanel implements ActionListener {
    ...
    private void initSurface() {
    	//setBackground(new Color(241, 235, 235));
        setBackground(new Color(243, 239, 239));
        //setBackground(new Color(239, 231, 231));
...
public class BubbleWallpaper extends JPanel {
	public static JPanel showSurface(int delay) {
		return new Surface(delay);
	}
	/*public static void main(String[] args) {
		JFrame f = new JFrame();
		JPanel pn = BubbleWallpaper.showSurface();
		f.add(pn);
		f.setSize(300, 300);
		f.setVisible(true);
	}*/
